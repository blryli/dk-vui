...
<template>
  <VPage edit>
    <div class="page">
      ...
      <h2>基础用法</h2>
      <p>
        通过 options 传入选项数据，默认字段映射为
        label=name、value=id、children=sub
      </p>
      <VCascader
        v-model="form.area"
        placeholder="请选择"
      ...
      <p>
        如果 options 是动态变化的，可以调用全局方法 updateCascaderOptions 来更新
      </p>
      <el-button @click="() => DKVui.updateCascaderOptions('department')"
        >更新options</el-button
      >
    </div>
  </VPage>
